# Bayes Classifier on the MNIST data.

# Code Flow:
    # 1. Import all relevant libraries.
    # 2. Bayes Clasifier class definition.
        # 2.1 Fit function.
...
if __name__ == '__main__':
    ...
    model = Bayes() # Initilalize the model
    ...
    print('Notice how the accuracy improved from NB')
